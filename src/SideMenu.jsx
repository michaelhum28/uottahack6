      ...
      <NavigationMenu.List className="NavigationMenuList">
        <NavigationMenu.Item>
          <NavigationMenu.Trigger className="NavigationMenuTrigger">
            Discover <CaretDownIcon className="CaretDown" aria-hidden />
              ...
              <li style={{ gridRow: 'span 3' }}>
                <NavigationMenu.Link asChild>
                  <a className="Callout" href="/">
                    ...
                    <div className="CalloutHeading">Near You</div>
                    <p className="CalloutText">Find the closest sustainable products near your location.</p>
                  </a>
                </NavigationMenu.Link>
              </li>

              <ListItem href="https://stitches.dev/" title="Ottawa">
                University of Ottawa stuff
              </ListItem>
              <ListItem href="/colors" title="Toronto">
                Toronto themed stuff
              </ListItem>
              <ListItem href="https://icons.radix-ui.com/" title="Montreal">
                French themed stuff
              </ListItem>
            </ul>
        ...
        <NavigationMenu.Item>
          <NavigationMenu.Link className="NavigationMenuLink" href="https://github.com/ja-der">
            About Us
          </NavigationMenu.Link>
        </NavigationMenu.Item>
