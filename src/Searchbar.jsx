        ...
        <form className="flex items-center w-full max-w-xl my-8 mx-12">   
            <div className="relative flex-grow">
                ...
                <div className="flex items-center">
                    <input type="search" id="default-search" className="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-400 rounded-full" placeholder="Search resources" required />
